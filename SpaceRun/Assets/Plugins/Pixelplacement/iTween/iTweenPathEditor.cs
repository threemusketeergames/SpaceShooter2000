...
{
    ItweenPath _target;
    //GameObject parentNode = _target.gameObject;
    GUIStyle style = new GUIStyle();
    public static int count = 0;
    Vector3 newNodeOffset = new Vector3(150, 0, 0);
    ...
    public override void OnInspectorGUI()
    {
        ...
        Debug.Log("Node count:" + _target.nodes.Count);
        for (int i = 0; i < _target.nodes.Count; i++)
        {
            //Debug.Log("Node:" + _target.nodes[i] + " at index: " + i);
